"""Gen II (Gold/Silver/Crystal) - charmap, scanner, encounter decoder."""
import struct
from .gen1_rgby import _GEN1_CHARMAP_EN


# ============================================================
# # _GEN2_CHARMAP_EN
# server.py lines 1028-1029
# ============================================================
...
# server.py lines 2537-2586
# ============================================================

def decode_gen2_encounters(map_group: int, map_number: int, current_rom: dict, text_tables: dict) -> str:
